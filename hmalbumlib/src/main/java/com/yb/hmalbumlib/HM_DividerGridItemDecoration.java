 ...
 *
 */
public class HM_DividerGridItemDecoration extends RecyclerView.ItemDecoration
{
    ...
    public HM_DividerGridItemDecoration(Context context, int dividerHight) {
    ...
    public HM_DividerGridItemDecoration(Context context, int dividerHight, int dividerColor) {
            final TypedArray a = context.obtainStyledAttributes(ATTRS);
            this.mDivider = a.getDrawable(0);
            a.recycle();
       if (dividerHight!=0){
